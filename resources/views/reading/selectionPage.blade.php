...
<div class="card-body">
    ...
    <div>
        <a class="nav-link dropdown-toggle text-center " style="color: rgb(98, 170, 222);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            <form id="myForm" action="{{ route('reading.fromDictionaryIndex') }}" method="POST"  class="form-inline">
                @csrf
                <div class="form-group mx-sm-3 mb-2">
                <select name="tableName" onchange="submitForm()" class="rounded" style="color:rgb(3, 3, 3); background-color: rgb(80, 141, 184); border-color: rgb(90, 156, 204)">
